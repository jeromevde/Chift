...
#   timestamp: 2026-09-06T15:40:19+00:00
...
class PaginatedCustomerV1Meta(BaseModel):
    total: float | None = Field(
        None, description="Total of existing items.", examples=[1]
    )
    taken: float | None = Field(
        None, description="Number of items returned.", examples=[1]
    )
    skipped: float | None = Field(
        None, description="Number of items skipped.", examples=[0]
    )
...
class UpdateCustomerTaxId(BaseModel):
    value: str | None = Field(
        None, description="Value of the customer tax ID.", examples=["FR123456789"]
    )
...
class CustomerV1(BaseModel):
    ...
    timezone: str | None = Field(
        None, description="Customer timezone.", examples=["Europe/Paris"]
    )
...
class PaginatedInvoiceV1Meta(BaseModel):
    total: float | None = Field(
        None, description="Total of existing items.", examples=[1]
    )
    taken: float | None = Field(
...
class UpdateInvoiceCoupon(BaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    coupon_id: str | None = Field(
...
class UpdateInvoiceAdditionalDisplayField(BaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    type: Literal["standard"] | None = Field(
...
class StandardBankAccount(BaseModel):
    ...
    currency: str | None = Field(
        None, description="Bank account currency.", examples=["EUR"]
    )
...
class Transaction(BaseModel):
    ...
    currency: str | None = Field(
        None, description="Transaction currency.", examples=["EUR"]
    )
...
class PaginatedCustomerV1(BaseModel):
    meta: PaginatedCustomerV1Meta | None = Field(None, title="PaginatedCustomerV1Meta")
    data: list[CustomerV1] | None = Field(None, description="List of CustomerV1.")
...
class UpdateCustomer(BaseModel):
    ...
    currency: str | None = Field(
        None,
        description="Customer currency. Can only be changed if the customer doesn't have existing invoices, a wallet or a payment method saved.",
        examples=["EUR"],
    )
    country: str | None = Field(
        None,
    ...
    tax_ids: list[UpdateCustomerTaxId] | None = Field(
        None, description="Customer tax IDs.", max_length=1
    )
    local_tax_number: str | None = Field(
        None, description="Customer local tax number.", examples=["12/345/67890"]
    ...
    bank_account: dict[str, Any] | None = Field(
        None,
        description="Custom bank account for the customer. If not defined and customer paying by bank transfer, the bank accounts configured in your account settings will be used.",
    )
    custom_payment_delay: float | None = Field(
...
class UpdateInvoice(BaseModel):
    ...
    line_items: list[CreateInvoiceLineItem] | None = Field(None, min_length=1)
    coupons: list[UpdateInvoiceCoupon] | None = None
    ...
    additional_display_fields: list[UpdateInvoiceAdditionalDisplayField] | None = Field(
        None,
        description="Ordered additional fields displayed on the invoice PDF. Invoice and customer custom properties are referenced by slug.",
        max_length=20,
    )
    customer: UpdateInvoiceCustomer | None = Field(
        None,
        description="Override customer details on the invoice. Only allowed for draft or grace period invoices.",
        title="UpdateInvoiceCustomer",
    )
...
class Invoice(BaseModel):
    ...
    customer: InvoiceCustomer | None = Field(None, title="InvoiceCustomer")
    seller: InvoiceSeller | None = Field(None, title="InvoiceSeller")
    subscription_id: str | None = Field(
        None,
        description="ID of the subscription related to the invoice.",
        examples=["sub_amiaWZ3lzDIWaoT"],
    ...
    additional_display_fields: list[InvoiceAdditionalDisplayField] | None = Field(
        None,
        description="Ordered additional fields displayed on the invoice PDF. Invoice and customer custom properties are referenced by slug.",
        examples=[None],
        max_length=20,
...
class InvoiceDeprecated(BaseModel):
    ...
    customer: InvoiceDeprecatedCustomer | None = Field(
        None, title="InvoiceDeprecatedCustomer"
    )
    seller: InvoiceDeprecatedSeller | None = Field(
    ...
    additional_display_fields: list[InvoiceDeprecatedAdditionalDisplayField] | None = (
        Field(
            None,
            description="Ordered additional fields displayed on the invoice PDF. Invoice and customer custom properties are referenced by slug.",
            examples=[None],
...
class PaginatedInvoiceV1(BaseModel):
    meta: PaginatedInvoiceV1Meta | None = Field(None, title="PaginatedInvoiceV1Meta")
    data: list[InvoiceDeprecated] | None = Field(None, description="List of InvoiceV1.")
